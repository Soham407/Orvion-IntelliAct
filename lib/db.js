...
const initialMockDocuments = [
  ...
  },
  {
    ...
    description: "Official quality management system standards and procedures compliance manual.",
    category: "iso",
    file_name: "iso_9001_quality_manual.pdf",
    file_type: "PDF",
    file_size: "2.1 MB",
    file_data: Buffer.from("%PDF-1.4 ... [Mock ISO 9001 Quality Manual content]").toString("base64"),
    uploaded_at: "2026-05-10T14:30:00.000Z"
  }
];
