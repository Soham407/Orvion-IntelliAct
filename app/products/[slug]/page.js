...
export default function ProductDetailPage() {
  ...
  const useTabLayout = product.content.sections.length > 5;
          ...
          <div className="shell">
            ...
            <div className="gs-reveal" style={{ maxWidth: "600px", margin: "0 auto 48px auto" }}>
              <div className="search-bar-wrapper" style={{
                ...
                <input
                  type="text"
                  placeholder={`Search ${product.title} items...`}
                  value={searchQuery}
              ...
              <div className="interactive-tab-layout gs-reveal" style={{
                ...
                <div ref={detailPanelRef} className="tab-details-panel" style={{
                  ...
                  <div className="tab-image-container" style={{
                    ...
                    <Image
                      src={activeIdx === 0 ? product.image : `/images/products/detail-${activeIdx % 4}.jpg`}
                      alt={activeSection.title}
                      fill
                      className="object-cover"
                      onError={(e) => {
                        e.target.src = product.image; // Fallback
                      }}
                    />
                  </div>
                </div>
